...
const Admin = () => {
    ...
    const [bookDetails, setBookDetails] = useState({ title: "", description: "", image: "", author: "", quantity: "", price: "" });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setBookDetails({ title: "", description: "", image: "", author: "", quantity: "", price: "" })
        } catch (err) {
                            ...
                            <div className="quantity-form">
                                <p><label htmlFor="quantity">Quantity ($)</label>
                                    <input
                                        name="quantity"
                                        type="text"
                                        placeholder="What is the quantity of the book (USD)"
                                        onChange={(e) => setBookDetails({ ...bookDetails, quantity: e.target.value })}
                                        required
                                    /></p>
                            </div>
